...
3. ทบทวนรายการสิทธิ์ที่ระบบขอ แล้วกด **Allow (อนุญาต)**:
   > ระบบต้องการสิทธิ์: **อ่าน/เขียน Google Sheet**, **ส่งอีเมลแทนคุณ**, และ **สร้าง trigger ตามเวลา**
...
- scope ที่ต้องใช้ถูก **auto-infer จากโค้ด** ตอน authorize ครั้งแรก (ไม่มีไฟล์ `appsscript.json` ที่ประกาศ scope ไว้)
