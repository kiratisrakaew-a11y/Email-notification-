...
> 📘 **สำหรับติดตั้งครั้งแรกทั้งกระบวนการ** (เริ่มตั้งแต่ Google Cloud Console — สร้าง GCP project,
> ตั้งค่า OAuth consent screen, IAM จนถึงการเชื่อมและ deploy Apps Script) ดูคู่มือฉบับเต็มที่ [`SETUP.md`](SETUP.md)
> README นี้เป็นคู่มือใช้งานแบบย่อสำหรับผู้ที่ตั้งค่า Google Cloud เรียบร้อยแล้ว
...
- บัญชี Google ที่เข้าถึงชีต DATA ได้ (ให้สิทธิ์แค่ดู/read-only ได้ เพราะระบบไม่เขียนลงชีต DATA)
